...
export default function EmailSenSuccess({setStep}: EmailSenSuccessProps) {
    ...
    <div className="relative w-24 h-24">
      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#6c63ff]/20 to-[#a78bfa]/20 animate-pulse" />
      <div className="relative w-24 h-24 bg-gradient-to-br from-[#6c63ff]/10 to-[#a78bfa]/10 rounded-full flex items-center justify-center border border-white/10 shadow-[0_0_40px_rgba(108,99,255,0.2)]">
    ...
    <div className="space-y-2">
      ...
      <p className="text-sm text-[#f0f0ff]/50 leading-relaxed max-w-[300px]">
    ...
    <div className="flex flex-col w-full gap-3 pt-2">
      <button
        ...
        className="w-full h-11 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-[#6366f1] to-[#a855f7] hover:from-[#585ce5] hover:to-[#9333ea] shadow-[0_8px_20px_-4px_rgba(99,102,241,0.4)] transition-all duration-300 active:scale-[0.98]"
      >
        Resend email
      </button>
      <Link
